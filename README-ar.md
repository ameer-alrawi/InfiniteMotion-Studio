...
### 3. إدارة الحالة بطريقة ذكية والتداخل بين الإطارات)
يتم إدارة حالة المشروع من خلال (History Stack) صارم وغير قابل للتغيير (Immutable)، مما يتيح التراجع والإعادة الفورية دون أي تأثير على الأداء و المشروع.
*   **توليد الإطارات المفتاحية تلقائياً (Auto-Keyframing):** يكتشف المحرك التغيرات في الانماكن (X، Y، الحجم، الدوران) ويقوم بإنشاء أو تحديث الإطارات تلقائياً.
*   **تخفيف الحركة المتقدم (Advanced Easing):** تتم معالجة الاستيفاء بين الإطارات المفتاحية بواسطة دوال رياضية مخصصة تدعم تأثيرات تخفيف متقدمة مثل `bounce-in`، `bounce-out`، و `elastic`، وتُحسب بدقة لكل إطار.
*   **مُحفزات التقاطع (Intersection Triggers):** يمكن بحركات دخول وخروج للعناصر لا تعتمد على الوقت فحسب، بل على التقاطع المشهد او مكان العرض. يتم حساب متى يدخل العنصر في مجال رؤية الكاميرا الافتراضية ويقوم بتركيب/إزالة (Mount/Unmount) حالة العنصر ديناميكياً.

## ✨ الميزات الرئيسية

*   🎥 **التحرير المكاني والكاميرا الافتراضية:** صمم على مساحة عمل لا نهائية. حرك الكاميرا الافتراضية (Pan, Zoom, Rotate) للتحرك داخل المشهدو انشاء مشاهد بأسلوب الموشن جرافيك.
...
*   ⚡ **التصدير السريع:** اصنع مشاهدك السينمائية مباشرة في المتصفح باستخدام واجهة ‎WebCodecs‎. صدّر فيديو عالي الجودة ومتزامن مع الصوت بصيغ ‎MP4‎ (H.264/AAC) أو ‎WebM (VP9/Opus).
*   🎨 **تنسيقات وتأثيرات متقدمة:** يدعم تدرجات لونية متحركة، وتأثيرات الزجاج الضبابي، والظلال، والحدود، وقطع أو إخفاء أجزاء من العناصر بطريقة احترافية لإضفاء لمسات احترافية على المشهد.،
*   💻 **إدراج الكود مباشرة:** أضف عناصر "الكود" لإدخال ‎HTML‎ و‎CSS‎ و‎SVG‎ مباشرة في عملية العرض، مما يفتح أمامك إمكانيات بصرية غير محدودة.

![الميزات الرئيسية](src/screenshot3.gif)

## 🌌 الخلفيات، الشبكات، وخامات
...
** الواجهة الأمامية **
*   [React 19](https://react.dev/) - هيكل واجهة المستخدم
*   [TypeScript](https://www.typescriptlang.org/) - حماية البيانات وتنظيم منطق البرنامج
*   [Tailwind CSS](https://tailwindcss.com/) - تنسيق سريع وعملي
*   [Lucide React](https://lucide.dev/) - أيقونات واضحة ومتناسقة

**محرك العرض و العناصر**
*   **HTML5 Canvas API** - محرك العرض الأساسي
*   **WebCodecs API & OfflineAudioContext** - تشفير الإطارات عالي الأداء والمكساج الصوتي
*   [`mp4-muxer`](https://github.com/Vanilagy/mp4-muxer) & [`webm-muxer`](https://github.com/Vanilagy/webm-muxer) - دمج (Multiplexing) كل الوسائط داخل المتصفح

## 💡 نظرة عامة على  العمل

### عناصر الواجهة
* **مركز العناصر (على اليسار):** أضف عناصر جديدة لمشروعك بسرعة. انقر على الأيقونات لإنشاء نصوص أو أكواد، رفع صور وفيديوهات، أو فتح اللوحة المخصصة للصوتيات لإدارة المؤثرات الصوتية.
* 
![مركز الأصول](src/screenshot10.png)

*   **مساحة العمل ((في الوسط):** استخدم `Space + سحب بالماوس` للتحرك حول مساحة العمل اللانهائية. قم بالتمرير للتقريب/التبعيد. حدد الأصول لتحريكها، تغيير حجمها، أو تدويرها.
*   
![مساحة العمل](src/screenshot6.png)

*   **الخط الزمني (timeline)(في الأسفل):** حرّك مؤشر التشغيل لمعاينة حركتك. بدّل أيقونة **المغناطيس** لتفعيل/تعطيل ميزة الجذب (Snapping). استمر بالضغط على `Shift` واسحب لإنشاء تحديد مربع لمقاطع متعددة.
*   
![الخط الزمني](src/screenshot7.png)

*   **لوحة الخصائص (على اليمين):** قم بتعديل خصائص العناصر المحدد حالياً أو اعداداة الكاميرا. اضبط الخطوط، الألوان، حركات الدخول/الخروج، وتأثيرات الظلال.
*   
![لوحة الخصائص](src/screenshot8.png)

### إنشاء الحركة (Animations)
1.  **الإطارات للعناصر(Asset Keyframing):** حدد عنصراً في مساحة العمل. حرك مؤشر التشغيل في الخط الزمني. حرك العنصر في مساحة العمل سيتم إنشاء إطار جديد تلقائياً! للحركة
2.  **الإطارات للكاميرا(Camera Keyframing):** انقر على زر `Camera KF` في ترويسة الخط الزمني. حرك مؤشر التشغيل، ثم اضبط التقريب/التحريك (Zoom/Pan) من شريط الأدوات العلوي لإنشاء حركات كاميرا ديناميكية.

### تصدير مشروعك
1. انقر على زر **Export** في الزاوية العلوية في اليمين.
2. اختر الصيغة المطلوبة (`MP4` أو `WebM`)، معدل الإطارات (حتى 60 إطاراً في الثانية)، والدقة.
3. انقر على **Start Encoding**. سيستخدم البرنامج معالج الرسوميات (GPU) المحلي لتصدير الفيديو.
